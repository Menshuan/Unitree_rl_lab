...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        # ),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.4, noise_range=(-0.02, 0.02), noise_step=0.01, border_width=0.25
        ),
        "wave": terrain_gen.HfWaveTerrainCfg(proportion=0.4, amplitude_range=(0.0, 0.02), num_waves=5.0),
...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.3, noise_range=(-0.02, 0.02), noise_step=0.01, border_width=0.25
        ),
    },
)
