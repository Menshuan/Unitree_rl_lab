...
from unitree_rl_lab.assets.robots.m3_parallel import M3_PARALLEL_CONFIG as ROBOT_CFG
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=None, # COBBLESTONE_ROAD_CFG, # COBBLESTONE_ROAD_CFG,  # None, ROUGH_TERRAINS_CFG
        collision_group=-1,
        physics_material=sim_utils.RigidBodyMaterialCfg(
            friction_combine_mode="multiply",
            restitution_combine_mode="multiply",
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformLevelVelocityCommandCfg(
        ...
        ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(
            lin_vel_x=(-0.2, 0.2), lin_vel_y=(-0.1, 0.1), ang_vel_z=(-0.1, 0.1)
        ),
...
class RewardsCfg:
    ...
    base_height = RewTerm(func=mdp.base_height_l2, weight=-1, params={"target_height": 0.83})
    ...
    fly = RewTerm(
        func=mdp.fly,
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*ankle_pitch.*"), "threshold": 1.0},
    )
    ...
    feet_air_time = RewTerm(
        ...
        weight=0.15,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*ankle_pitch.*"), "threshold": 0.4},
    )
    feet_slide = RewTerm(
        func=mdp.feet_slide,
        weight=-0.25,
    ...
    feet_too_near = RewTerm(
        ...
        weight=-2.0,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_pitch.*"]), "threshold": 0.2},
    )
    feet_stumble = RewTerm(
        func=mdp.feet_stumble,
        weight=-2.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=[".*ankle_pitch.*"])},
    )
    ...
    base_height = RewTerm(
        ...
        weight=-1, 
        params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*pelvis.*"]), "target_height": 0.80}
    )
    feet_energy = RewTerm(
        func=mdp.energy,
        weight=-1e-3,
