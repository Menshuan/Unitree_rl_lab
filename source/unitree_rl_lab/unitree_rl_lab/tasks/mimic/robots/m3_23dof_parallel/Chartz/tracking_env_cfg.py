...
from unitree_rl_lab.assets.robots.m3_parallel import M3_PARALLEL_ACTION_SCALE
...
class ActionsCfg:
    ...
    JointPositionAction = mdp.JointPositionActionCfg(
        asset_name="robot", joint_names=[".*"], scale=M3_PARALLEL_ACTION_SCALE, use_default_offset=True
    )
