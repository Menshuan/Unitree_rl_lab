...
M3_PARALLEL_CONFIG = GLRArticulationCfg(
...
M3_PARALLEL_ACTION_SCALE = {}
for a in M3_PARALLEL_CONFIG.actuators.values():
    ...
    for n in names:
        if n in e and n in s and s[n]:
            M3_PARALLEL_ACTION_SCALE[n] = 0.25 * e[n] / s[n]
print("ACTION SCALE :%s" % str(M3_PARALLEL_ACTION_SCALE))