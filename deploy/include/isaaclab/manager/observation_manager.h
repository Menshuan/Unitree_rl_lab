...
public:
    ...
    const std::vector<float> compute_group(const std::string& group_name)
    {
        ...
        //     // 计算当前观测值
        //     auto current_obs = term.func(this->env, term.params);
        //     term.add(current_obs);
            
        //     // 打印调试信息
        //     std::cout << "Observation term: " << group_name << "." << "[" 
        //             << &term - &group_terms[0] << "]" 
        //             << " - current value size: " << current_obs.size() 
        //             << " - values: ";
        //     for(size_t i = 0; i < current_obs.size(); ++i) {
        //         std::cout << current_obs[i] << " ";
        //     }
        //     std::cout << std::endl;
        // }
        ...
        // if (obs.size()==960){
        //     std::cout << " If using gym history: " << (use_gym_history ? "True" : "False") << std::endl;
        //     std::cout << "Full combined observation: [";
        //     for(size_t i = 0; i < obs.size(); ++i) {
        //         std::cout << obs[i];
        //         if(i < obs.size() - 1) std::cout << ", ";
        //     }
        //     std::cout << "]" << std::endl;
        // }
        return obs;
